...
setMethod(
  ...
  function(object) {
    ...
    cat(
      " Number of DPs using this concentration param:",
      object@numdp, "\n"
    )
  }
)
...
setMethod(
  ...
  function(object) {
    ...
    if (object@numdata == 0) {
      cat(
        " Number of child data tables in each cluster:",
        object@classnd, "\n"
      )
    } else {
      cat(
      ...
      cat(
        " Number of data items in each category:",
        table(object@datass), "\n"
      )
    }
  }
...
setMethod(
  ...
  function(object) {
    ...
    if (npseudo > 0) {
      cat(
        " Number of pseudo DP nodes for prior info:",
        npseudo, "\n"
      )
      cat(
        " Index of pseudo DP nodes:",
    ...
    cat(
      ...
      sapply(
        object@dp[1:min(10, numdp)],
        function(x) x@numdata
      ), "...\n"
    )
    cat(
      " Index of conparam per DP:",
    ...
    if (length(object@initcc) == 1) {
      cat(
        " Initialised with", object@initcc,
